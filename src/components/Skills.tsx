      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">{t.skills.tools}</h3>
          </div>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
            {devOpsTools.map((tool, index) => (
              <motion.div
                ...
                className="glass-card rounded-xl p-4 text-center hover:bg-white/10 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10 group"
              >
