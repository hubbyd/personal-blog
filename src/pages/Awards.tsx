  ...
  const awards = [
    {
      ...
      image: "/assets/award-sanchuang-2024.jpg",
    },
    {
      name: t.about.awards.items.careerPlanning,
      category: "competition",
      date: "2024",
      level: "school",
      icon: Trophy,
      color: "from-orange-500 to-yellow-500",
      image: "/assets/award-career-2024.jpg",
    },
    {
      name: t.about.awards.items.boxueCup2025,
      category: "competition",
      date: "2025",
      level: "school",
      icon: Trophy,
      color: "from-indigo-500 to-blue-500",
      image: "/assets/award-boxue-2025.jpg",
    },
    {
    ...
    },
    {
      ...
      image: "/assets/award-student-2025.jpg",
    },
    {
    ...
    },
    {
      ...
      image: "/assets/award-computer-2025.jpg",
    },
    {
      name: t.about.awards.items.loveLetter,
      category: "competition",
      date: "2025",
      level: "school",
      icon: Star,
      color: "from-pink-500 to-rose-500",
      image: "/assets/award-poem-2025.jpg",
    },
    {
      ...
      image: "/assets/award-league-2026.jpg",
    },
    {
      name: t.about.awards.items.boxueCup2026,
      category: "competition",
      date: "2026",
      level: "school",
      icon: Trophy,
      color: "from-indigo-500 to-violet-500",
      image: "/assets/award-boxue-2026.jpg",
    },
    {
      name: t.about.awards.items.socialPractice,
      category: "honor",
      date: "2026",
      level: "school",
      icon: Award,
      color: "from-amber-500 to-yellow-500",
      image: "/assets/award-social-2026.jpg",
    },
  ];

  const stats = [
    { number: "11", label: t.awards.totalAwards },
    { number: "2", label: t.awards.firstPrizes },
    { number: "2", label: t.awards.corePapers },
    { number: "3", label: t.awards.yearsActive },
  ];
